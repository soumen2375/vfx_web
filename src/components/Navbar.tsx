...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#070A11] border-b border-white/10 transition-all duration-300">
      {/* TOP UTILITY BAR */}
      <div className="bg-[#05070D] border-b border-white/5 py-2 px-4 sm:px-6 lg:px-8 text-xs text-gray-400">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          {/* Left: Tagline */}
          <div className="flex items-center space-x-2">
            <Rocket className="w-3.5 h-3.5 text-red-500 shrink-0" />
            <span className="text-[11px] font-medium tracking-wide text-gray-300">
              Transforming Imagination Into Cinematic Reality
            </span>
          </div>

          {/* Right: Region Selector & Socials */}
          <div className="hidden md:flex items-center space-x-6">
            <div className="flex items-center space-x-4 text-[11px]">
              {/* Region Selector */}
              <div className="flex items-center space-x-1 text-gray-200 bg-white/5 px-2.5 py-0.5 rounded border border-white/10 cursor-pointer hover:bg-white/10 transition-colors">
                <span>India</span>
            ...
            {/* Social Icons */}
            <div className="flex items-center space-x-3 pl-2 border-l border-white/10 text-gray-400">
              <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-red-400 transition-colors">
                <Linkedin className="w-3.5 h-3.5" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-red-400 transition-colors">
                <Instagram className="w-3.5 h-3.5" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noreferrer" className="hover:text-red-400 transition-colors">
                <Youtube className="w-3.5 h-3.5" />
              </a>
              <a href="https://x.com" target="_blank" rel="noreferrer" className="hover:text-red-400 transition-colors">
      ...
      <div 
        className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 transition-all ${
      ...
      >
        <div className="flex items-center justify-between">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg font-heading text-xs font-bold tracking-wider transition-all flex flex-col items-center group ${
                      isActive
                        ? 'text-red-500'
          ...
          <div className="hidden lg:flex items-center space-x-3">
            {/* Circular Search Trigger */}
            <button
              onClick={onOpenSearch}
              className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white border border-white/10 flex items-center justify-center transition-all hover:scale-105"
              title="Search studio content"
            >
